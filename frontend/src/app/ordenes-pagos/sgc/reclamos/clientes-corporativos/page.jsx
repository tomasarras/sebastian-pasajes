...
export default function OrdenesPagoReclamosClientesCorporativos() {
  const { 
    ...
    selectedEntity,
    actionColumn,
  } = useCRUDModals("cliente corporativo")
  const reclamosCorporativos = useIsoReclamosCoorporativos()
  ...
  const columns = useMemo(() => {
    ...
    return newColumns;
  }, [reclamosCorporativos]); 

  return (
  <Container>
    <div className="shadow rounded-lg bg-white p-2 md:p-4">
      <MainHeader mainTitle="Reclamos Cliente Corporativos" {...mainHeaderProps} />
      <hr/>
      <div className="py-8 md:py-16">
        <Table
          className="shadow"
          columns={columns}
          data={reclamosCorporativos}
          striped
          responsive
